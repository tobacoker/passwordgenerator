...
while (isNaN(passwordOptions.length) || passwordOptions.length < 8 || passwordOptions.length > 128) {
  alert("Password length must be a number between 8 and 128.");
  passwordOptions.length = parseInt(prompt("Enter password length (between 8 and 128 characters):"));
}
